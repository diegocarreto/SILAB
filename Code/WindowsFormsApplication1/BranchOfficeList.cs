...
{
    public partial class BranchOfficeList : BaseForm
    {
        #region Memebers
        ...
        private posb.BranchOffice Entity { get; set; }
        ...
        {
            this.Entity = new posb.BranchOffice();
        ...
        {
            if (this.Confirm("¿Realmente deseas eliminar la sucursal [" + this.EntityName + "]?"))
            {
                ...
                if (this.Entity.Delete())
                {
                    ...
                    this.Alert("Ocurrió un error al intentar eliminar la sucursal [" + this.EntityName + "]", eForm.TypeError.Error);
            }
        }
