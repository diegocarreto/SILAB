...
{
    public partial class ProviderList : BaseForm
    {
        #region Memebers
        ...
        private posb.Provider Entity { get; set; }
        ...
        {
            var edit = new ProviderEdit(Id);

            edit.Result += new ProviderEdit.Communication(Result);
        ...
        {
            if (this.Confirm("¿Realmente deseas eliminar el proveedor [" + this.EntityName + "]?"))
            {
                ...
                if (this.Entity.Delete())
                {
                    ...
                    this.Alert("Ocurrió un error al intentar eliminar el proveedor [" + this.EntityName + "]", eForm.TypeError.Error);
            }
        }
